...
void ImplicitLCP::explicit_step(double dt)
{
...
void ImplicitLCP::step_matrix_free(double dt)
{
    // TODO:
}

void ImplicitLCP::step_sparse(double dt)
{
    // TODO:
}
                                                        ...
                                                        double newton_tol, double linear_tol)
{
    ...
    for (int n = 0 ; n < newton_it; n++) {
        ...
        for (int colIdx = 0; colIdx < numContacts; colIdx++) {
            ...
            // collision values
            Vector3d normal = contacts[colIdx]->normal;
...
void ImplicitLCP::setup_implicit_lcp_deformable(MatrixXd& q_n, const MatrixXd& q_unconstrained, MatrixXd &u_n, const MatrixXd &u_tilde,
                                                ...
                                                double newton_tol, double linear_tol)
{
    ...
    VectorXd phi_elastic(numTets); phi_elastic.setZero();
    VectorXd phi_normal(numContacts); phi_normal.setZero();
    VectorXd phi_friction(2*numContacts); phi_friction.setZero();
    VectorXd lambda_elastic(numTets); lambda_elastic.setZero();
    VectorXd lambda_normal(numContacts); lambda_normal.setZero();
    VectorXd lambda_friction(2*numContacts); lambda_friction.setZero();
