...
//    peg->scaleMesh(2);
    peg = new GodObject(m_devicePtr,0,"/home/agalvan-admin/ImplicitNonlinearComplementarity/resources/PegInHole/peg.obj");
    peg->scaleMesh(0.025);
    peg->scaleMesh(0.99);
...
//    block->scaleMesh(2);
    block = new RigidObject(0,"/home/agalvan-admin/ImplicitNonlinearComplementarity/resources/PegInHole/block.obj");
    block->scaleMesh(.025);
    ...
    block->set_local_pos(Vector3d(0,0,-0.25));
                                ...
                                block_start, block_end, block_vertices, block_triangles, contacts,colvis))
    {
        ...
        for (int newtonit = 0; newtonit < numNewtonIt; newtonit++)
        {
            ...
            for (int cidx = 0; cidx < num_contacts; cidx++)
            {
                ...
                {
                    // normal constraints
                    double C_n = n.dot(( x + contact->contact_wrt_objectA ) - (block->x + contact->contact_wrt_objectB) );
                    cout << "C_n = " << C_n << endl;
