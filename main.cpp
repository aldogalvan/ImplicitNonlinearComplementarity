...
bool sphereTriangleCollision(double sphereRadius, const cVector3d& spherePosition,
                             ...
                             const cVector3d& triangleVertex3, cVector3d& contactNormal,
                             cVector3d& contactPoint, double& penetrationDepth);
...
void updateHaptics(void)
{
    ...
    while(simulationRunning)
    {
        ...
        cVector3d normal; cVector3d contactPoint; double depth;

        if (sphereTriangleCollision(0.025,pos,
                                vertex1,vertex2,vertex3,
                                normal,contactPoint,depth))
        {
            cout << "Collision" << endl;
        }

        cursor->setLocalPos(pos);
        hapticDevice->setForceAndTorqueAndGripperForce(cVector3d(0,0,0),cVector3d(0,0,0),0.0);
                             ...
                             cVector3d& contactPoint, double& penetrationDepth)
{
    ...
    penetrationDepth = sphereRadius - signedDistance;
    contactNormal = (projection - spherePosition);
